"""
Test data generation for validation system testing.

This module provides utilities for generating test content that covers
various scenarios and edge cases for comprehensive validator testing.
"""
...
class TestDataGenerator:
    ...
    async def generate_content(self, 
                             content_type: str, 
                             scenario: MockScenario) -> TestContent:
    ...
    async def generate_known_good_content(self, 
                                        content_type: str,
                                        validator_id: str) -> TestContent:
        ...
        if content_type == "chapter":
            ...
            return self._create_good_scene_content(validator_id)
        else:
            return self._create_generic_good_content(content_type, validator_id)
            
    async def generate_known_bad_content(self, 
                                       content_type: str,
                                       validator_id: str) -> TestContent:
        ...
        if content_type == "chapter":
            ...
            return self._create_bad_scene_content(validator_id)
        else:
    ...
    async def _generate_low_quality_content(self, content_type: str) -> TestContent:
        ...
        if content_type == "chapter":
            ...
            content = {
                ...
                "chapters": [
                    {"chapter_id": "ch1", "title": "chapter", "word_count": 800}  # Too short
                ],
                ...
                "intended_tone": "mixed",
                "structural_issues": ["inconsistent_pacing", "weak_character_development"],
    ...
    async def _generate_problematic_content(self, content_type: str) -> TestContent:
        ...
        if content_type == "chapter":
            ...
            content = {
                ...
                "chapters": [
                    {"chapter_id": "ch1", "title": "Bad Chapter", "word_count": 100}
                ],
    ...
    def _create_bad_chapter_content(self, validator_id: str) -> TestContent:
        ...
        if validator_id == "content_validator":
            base_content.update({
                ...
                "major_issues": ["tone_shifts", "plot_inconsistencies", "character_errors"]
            })
        elif validator_id == "quality_originality_validator":
            base_content.update({
