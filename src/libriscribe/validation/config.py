...
from .interfaces import ValidationConfig, ConfigurationError
...
class ValidationConfigManager:
    ...
    def __init__(self, config_dir: Optional[str] = None):
        self.config_dir = Path(config_dir) if config_dir else Path.cwd() / ".libriscribe"
        self.config_dir.mkdir(exist_ok=True)
        
    def load_config(self, project_id: str, genre: Optional[str] = None) -> ValidationConfig:
    ...
    def create_default_config_file(self, project_id: Optional[str] = None) -> Path:
