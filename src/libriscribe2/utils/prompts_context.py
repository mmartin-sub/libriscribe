# src/libriscribe2/utils/prompts_context.py

"""
This module defines various prompt templates and related constants
used for AI content generation within libriscribe2.
"""
...
def clean_worldbuilding_for_category(
