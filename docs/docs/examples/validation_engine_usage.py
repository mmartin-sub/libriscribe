...
and system code in libriscribe2.
...
class MockValidator:
    ...
    async def validate(self, content: Any, context: dict[str, Any]):
        ...
        return ValidatorResult(
            ...
            findings=findings,
            metrics={"quality_score": 85.0, "execution_time": 0.5},
        )
...
async def demonstrate_basic_usage():
    ...
    config = ValidationConfig(
        ...
        validator_configs={
            ...
            "publishing_validator": {"check_metadata": True, "check_formatting": True},
        },
    )
...
async def demonstrate_configuration_management():
    ...
    config = ValidationConfig(
        ...
        validator_configs={
            ...
            "quality_validator": {"check_grammar": True, "check_readability": True},
        },
...
async def demonstrate_validator_registration():
    ...
    await engine.register_validator_class(QualityValidator, check_grammar=True, check_readability=True)
...
async def demonstrate_error_handling():
    ...
    try:
        await engine.get_registered_validators()
    ...
    try:
        await engine.load_config_from_file("non_existent_config.yaml")
        print("❌ This should have failed!")
    except Exception as e:
        print(f"✅ Caught expected error: {e}")
