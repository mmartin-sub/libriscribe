...
- `mock_data_dir` (Optional[str]): Directory for storing mock data. Defaults to `.libriscribe2/mock_data`
...
- `.libriscribe2/mock_data/recorded_interactions.json`: Recorded real AI interactions
- `.libriscribe2/mock_data/mock_responses.json`: Custom mock responses
...
from src.libriscribe2.validation.interfaces import ValidatorBase, ValidatorResult
