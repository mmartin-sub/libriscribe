...
class Response:
    ...
    inner_messages: Sequence[SerializeAsAny[BaseAgentEvent | BaseChatMessage]] | None = ...
...
class ChatAgent(ABC, TaskRunner, ComponentBase[BaseModel]):
    ...
    @abstractmethod
    def on_messages_stream(self, messages: Sequence[BaseChatMessage], cancellation_token: CancellationToken) -> AsyncGenerator[BaseAgentEvent | BaseChatMessage | Response, None]:
