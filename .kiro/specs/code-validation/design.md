...
The validation system extends the existing `ProjectKnowledgeBase` class from `src/libriscribe2/knowledge_base.py` rather than creating new data models. This ensures compatibility with the existing LibriScribe system.

```python
# Extensions to existing ProjectKnowledgeBase class
from libriscribe2.knowledge_base import ProjectKnowledgeBase, Character, Chapter, Scene
...
```python
from libriscribe2.knowledge_base import ProjectKnowledgeBase, Character, Chapter
